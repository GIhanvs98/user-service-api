...
import com.gihanvs.quickcart.user_service_api.Entity.FileResource;
import com.gihanvs.quickcart.user_service_api.Entity.User;
import com.gihanvs.quickcart.user_service_api.Entity.UserAvatar;
import com.gihanvs.quickcart.user_service_api.dto.request.RequestSystemUserAvatarDto;
import com.gihanvs.quickcart.user_service_api.exception.EntryNotFoundException;
import com.gihanvs.quickcart.user_service_api.exception.InternalServerException;
import com.gihanvs.quickcart.user_service_api.repo.SystemUserAvatarRepo;
import com.gihanvs.quickcart.user_service_api.repo.UserRepo;
import com.gihanvs.quickcart.user_service_api.service.FileService;
import com.gihanvs.quickcart.user_service_api.service.SystemUserAvatarService;
import com.gihanvs.quickcart.user_service_api.util.CommonFileSavedBinaryDataDTO;
        ...
        if (selectedAvatar.isPresent()) {
            try {
                ...
                selectedAvatar.get().setFileResource(
                   new FileResource(fileDataExtractor.blobToByteArray(resource.getFileName()),
